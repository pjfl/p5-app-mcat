...
MCat::Authentication::Realms::OAuth - Base class for OAuth authentication

=head1 Synopsis

   package MCat::Authentication::Realms::MyProvider;
...
L<DBIC authentication realm|MCat::Authentication::Realms::DBIC>
...
=item L<MCat::Authentication::Realms::DBIC>
