...
requires "HTML::Forms" => "v0.2.1";
requires "HTML::Forms::Model::DBIC" => "v0.2.0";
requires "HTML::Parser" => "3.76";
requires "HTML::StateTable" => "v0.2.1";
requires "HTTP::Message" => "6.44";
requires "HTTP::Request::Webpush" => "0.15";
...
requires "Net::IP::Match::Regexp" => "1.01";
...
requires "Web::Components::API" => "v0.1.15";
